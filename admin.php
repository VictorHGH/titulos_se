<?php
//echo $_SERVER['REMOTE_ADDR'];exit();//|| $_SERVER['REMOTE_ADDR']=='127.0.0.1' 
...
-->
		...
		<section class="full-box section">
			<div class="container">
				<div class="row">
					<div class="col-xs-12">
						<h1 class="text-center text-titles">Módulo de Administración</h1>
					</div>
				</div>
				<p><br>
				</p>
				<p class="text-center">Oprima sobre una de las siguientes opciones:<br>
				</p>
				<div class="row text-center list-unstyled table-bordered">
					<h2><a href="subir_datos_titulos.php">Subir listado de títulos</a></h2>
					<h2><a href="completa_datos_titulos.php">Completar datos de títulos entregados</a></h2><br>
				</div>
			</div>
		</section>
